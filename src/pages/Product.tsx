  ...
  useEffect(() => {
    const fetchProductComparison = async () => {
      ...
      try {
        ...
        const result = await compareProductPrices(id);
                ...
                <div className="space-y-3">
                  ...
                  {maxiPaliProduct && (
                    <div className={cn(
                      ...
                      compareResult?.bestPrice?.store === "MaxiPali" && "border-yellow-400 bg-yellow-50 dark:bg-yellow-900/20"
                    )}>
                      <div className="w-16 h-16 rounded bg-muted overflow-hidden flex-shrink-0">
                        <img 
                          src={maxiPaliProduct.imageUrl || 'https://placehold.co/400?text=No+Image'} 
                          alt={maxiPaliProduct.name} 
                      ...
                      <div className="flex-grow">
                        <div className="flex justify-between">
                          <div>
                            ...
                            <p className="text-sm line-clamp-1">{maxiPaliProduct.name}</p>
                          </div>
                  ...
                  {masxMenosProduct && (
                    <div className={cn(
                      "p-3 rounded-lg border flex gap-3",
                      compareResult?.bestPrice?.store === "MasxMenos" && "border-green-400 bg-green-50 dark:bg-green-900/20"
                    )}>
                      <div className="w-16 h-16 rounded bg-muted overflow-hidden flex-shrink-0">
                        <img 
                          src={masxMenosProduct.imageUrl || 'https://placehold.co/400?text=No+Image'} 
                          alt={masxMenosProduct.name} 
                          className="w-full h-full object-cover"
                        />
                      </div>
                      <div className="flex-grow">
                        <div className="flex justify-between">
                          <div>
                            ...
                            <p className="text-sm line-clamp-1">{masxMenosProduct.name}</p>
                          </div>
                          <div className="text-right">
                  ...
                  {/* Not found in one store */}
                  {!maxiPaliProduct && (
                    <div className="p-3 rounded-lg border border-muted bg-muted/10 flex gap-3">
                      ...
                      <div className="flex-grow flex items-center">
                        <div>
                          <h4 className="font-medium">MaxiPali</h4>
                          <p className="text-sm text-muted-foreground">Product not available at this store</p>
                        </div>
                      </div>
                    </div>
                  )}

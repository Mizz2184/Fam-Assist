...
export const compareProductPrices = async (
  ...
  try {
    console.log(`Comparing prices for product: ${productName}, barcode: ${barcode || 'N/A'}`);
    ...
    // Get the products from both responses
    const maxiPaliProducts = maxiPaliResponse.products;
    const masxMenosProducts = masxMenosResponse.products;
